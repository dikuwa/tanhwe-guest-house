      ...
      <main>
        ...
        <section className="mx-auto grid max-w-[1180px] gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[.85fr_1.15fr] lg:py-28">
          <div>
            ...
            <div className="mt-8 space-y-7">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-muted-foreground">{settings.location}</p>
                </div>
              </div>
              <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold">Stay times</p>
            ...
            <ContactActions phone={settings.phone} whatsapp={settings.whatsapp} className="mt-10" />
          </div>
          <div className="min-h-[420px] rounded-xl bg-[color-mix(in_oklch,var(--secondary)_9%,var(--background))] p-8 sm:p-12">
            ...
            <a
              className="mt-8 inline-flex font-semibold text-secondary underline decoration-secondary/30 underline-offset-4"
