...
Not claimed complete: automatic email delivery, a live backup restore drill, Cloudflare custom-domain configuration, credential rotation, and owner confirmation of real room content.
