...
export const metadata: Metadata = {
  title: "Rooms | Tanhwe Guest House",
  description: "Browse accommodation at Tanhwe Guest House in Mukwe, Namibia.",
};
        ...
        <section className="bg-[color-mix(in_oklch,var(--secondary)_8%,var(--background))] px-4 py-10 sm:px-6 sm:py-16 lg:py-20">
          <div className="mx-auto max-w-[1180px]">
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">
              Clear nightly prices, breakfast included, and a direct line to the people preparing
              your stay.
            </p>
          </div>
        </section>
